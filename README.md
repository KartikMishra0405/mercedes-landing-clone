...
- Handling `position: sticky` and `position: fixed`  
- Recreating UI by observing real websites  
- Improving design sense (spacing, alignment, hierarchy)  
...
- Matching a clean and premium design feel  
...
Learning web development and building projects step by step 🚀
